...
import com.example.client.model.StorageFileInfo;
import com.example.client.model.StorageFileInfoNode;
...
public class Client {
    ...
    public static void init(String trackerAddress,int trackerPort){
        Client.trackerAddress = trackerAddress;
        Client.trackerPort = trackerPort;
    }
